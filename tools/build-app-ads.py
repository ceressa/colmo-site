...
HEADER = [
    ...
    "# ayni. Magaza kaydindaki web sitesi alani Play'de colmo.bardino.app",
    "# (2026-09-12'den beri), iOS'ta sonraki surume kadar colmo.dozi.app; eski",
    "# adres dozi-redirect-colmo deposundan bu dosyanin aynisini sunuyor.",
    "#",
    ...
    "#",
    "# Yayina aldiktan SONRA https://colmo.bardino.app/app-ads.txt adresini GET",
